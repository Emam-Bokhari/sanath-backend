...
router.get(
  "/admin/all-enqueries",
  isAdmin,
  EnqueryControllers.getAllEnqueriesForAdmin,
);
router.get(
  "/admin/all-enqueries/:enqueryId",
  isAdmin,
  EnqueryControllers.getEnqueryByIdForAdmin,
);
...
router
  ...
  .patch(
    isAgent,
    checkSubscription("leadAccess"),
    EnqueryControllers.updateEnqueryStatus,
  );
